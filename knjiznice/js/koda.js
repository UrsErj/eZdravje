...
function dodajMeritveVitalnihZnakov() {
	...
	var srcniUtrip = $("#dodajVitalnoSrcniUtrip").text();
	...
	if (!ehrId || ehrId.trim().length == 0) {
      ...
      // https://rest.ehrscape.com/rest/v1/template/Vital%20Signs/example
		    ...
		    "vital_signs/heart_beat/any_event/beatr": srcniUtrip
		};
...
window.addEventListener('load', function() {
	...
	var dodajOpomnik = function(){
		var naziv_opomnika = "merjenje srčnega utripa";
		var cas_opomnika = document.querySelector("#cas_opomnika").value;
		document.querySelector("#naziv_opomnika").value="merjenje srčnega utripa";
